            ...
            <div class="modal-body">
                <form id="updateEventForm" action="${pageContext.request.contextPath}/events" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="eventName" placeholder="${events.eventName}" >
                    </div>
                    <div class="mb-3">
                        <label for="date-time" class="col-form-label">Date-Time:</label>
                        <input type="date" id="date-time" class="form-control" name="eventStart"  placeholder="${events.eventStart}">
                    </div>
                    <div class="mb-3">
                        <label for="img-text" class="col-form-label">Image:</label>
                        <input type="file" id="img-text" class="form-control" name="imgEvent"  placeholder="${events.imgEvent}">
                    </div>
                    <div class="mb-3">
                        <label for="location-text" class="col-form-label">Location:</label>
                        <input type="text" id="location-text" class="form-control" name="location"  placeholder="${events.location}">
                    </div>
                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">Description:</label>
                        <textarea class="form-control" id="message-text" name="description"  placeholder="${events.description}"></textarea>
                    </div>
                    <div class="mb-3">
